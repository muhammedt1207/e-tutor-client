...
const TopCourses = ({topCourses}) => {
  ...
  return (
    <div className="relative overflow-x-auto border p-2 shadow-md flex-row justify-center items-center mt-4">
    ...
    <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 ">
        ...
        <tbody>
            {topCourses.topCourses &&topCourses.topCourses.map((course,index)=>(
